...
const AttestationDeFormationDureePDF = ({ values }) => (
  <Document>
      ...
      <Page size="A4" orientation="landscape" style={styles.page} key={index}>
        <View style={styles.content}>
          ...
          <Text style={styles.body}>
            La Direction de l’Etablissement Privé de la Formation Professionnelle
            WADFOR :{"\n"}
            Vu le décret n°01-419 du 5 chaoual 1422 correspondant au 20 décembre
            2001 fixant les conditions de création d’ouverture, de contrôle des
            établissements privés de dénations professionnelle.{"\n"}
...
export default AttestationDeFormationDureePDF;
