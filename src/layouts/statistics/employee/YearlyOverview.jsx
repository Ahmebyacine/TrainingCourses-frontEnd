...
export const YearlyOverview = ({ selectedYear,yearlyData,loading }) => {
  ...
  const paymentStatusData = [
    { name: "Paid", value: yearlyData?.statistics.reduce((sum, stat) => sum + stat.performance.yearlyTotal.totalPaid, 0) },
    { name: "Unpaid", value: yearlyData?.statistics.reduce((sum, stat) => sum + stat.performance.yearlyTotal.totalUnpaid, 0) },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Employee Statistics {selectedYear}</CardTitle>
