...
export const EmployeeStatisticsManager = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const response = await api.get(`/api/user/statistics/manager?year=${selectedYear}`);
  ...
  return (
    <div className="container mx-auto py-6 px-5 md:px-10" dir="rtl">
      <h1 className="md:text-3xl text-xl font-bold mb-6 text-right">لوحة إحصائيات الموظفين</h1>
